        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6">
          ...
          >
            ...
            <Link
              ...
              className="block p-6 cursor-pointer focus:outline-none focus-visible:ring-2 focus-visible:ring-indigo-500 focus-visible:ring-offset-2 dark:focus-visible:ring-offset-gray-900"
            >
              {/* Hover Gradient */}
              <div
                aria-hidden
              ...
              {/* CTA */}
              <div className="relative z-10 mt-5 text-indigo-600 dark:text-indigo-400 font-medium">
                Read more about me →
              </div>
            </Link>
          </motion.div>
